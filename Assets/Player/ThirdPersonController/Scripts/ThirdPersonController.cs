...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
       ...
       // [Range(0, 1)] public float FootstepAudioVolume = 0.5f;
        ...
        //p("Time required to pass before entering the fall state. Useful for walking down stairs")]
        ...
        private void Crouch()
        {
            if (_input.iscrouching && Grounded && !_input.sprint)
            {
                _animator.SetBool("crouching", _input.iscrouching);
